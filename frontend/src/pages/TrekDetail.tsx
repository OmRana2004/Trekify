    ...
    return (
      <div className="text-center py-20">
        ...
        <p className="text-gray-600 mt-4">
          Please check the trek you are trying to view.
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-10">
      <Helmet>
        ...
        <meta
          name="description"
          content={`Trek details for ${trek.name} in ${
            trek.location
          }. ${trek.description.slice(0, 150)}...`}
        />
      </Helmet>
      ...
      <nav className="text-sm text-gray-600 mb-6" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1">
          ...
          <li>
            <a href="/treks" className="hover:underline text-green-600">
              Treks
            </a>
            <span className="mx-2">/</span>
          </li>
      ...
      <div className="mt-8 space-y-6">
        <h1 data-aos="fade-up" className="text-4xl font-bold text-gray-900">
          {trek.name}
        </h1>
        <p
          data-aos="fade-up"
        ...
        <p data-aos="fade-up" data-aos-delay="300" className="text-gray-800">
          {trek.description}
        </p>
        {trek.itineraryPdf && (
      ...
      {["itinerary", "inclusions", "gearList"].map(
        (key) =>
          Array.isArray(trek[key]) &&
          trek[key].length > 0 && (
      ...
      {trek.testimonials && trek.testimonials.length > 0 && (
        <section className="mt-20">
          <h2
            data-aos="fade-up"
            className="text-3xl font-extrabold text-center text-gray-900 mb-6 font-serif"
          >
            What Trekkers Say
          </h2>
